...
public class ModItems {
    ...
    public static final RegistryObject<Item> MUD_BALL = ITEMS.register("mud_ball",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS)));

    public static final RegistryObject<Item> DRIED_MUD_BALL = ITEMS.register("dried_mud_ball",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.DRIED_MUD_BALL)));
    ...
    public static final RegistryObject<Item> BIRCH_SWORD = ITEMS.register("birch_sword",
            () -> new SwordItem(ModTiers.BIRCH,  3, -2.4F,
                    new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS)));
    ...
    public static final RegistryObject<Item> ROUGH_SUGAR = ITEMS.register("rough_sugar",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.ROUGH_SUGAR)));
    ...
    public static final RegistryObject<Item> CUCUMBER = ITEMS.register("cucumber",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.CUCUMBER)));

    public static final RegistryObject<Item> CROUTON = ITEMS.register("crouton",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.CROUTON)));

    public static final RegistryObject<Item> LETTUCE = ITEMS.register("lettuce",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.LETTUCE)));

    public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.TOMATO)));

    public static final RegistryObject<Item> SALAD = ITEMS.register("salad",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TWINDLING_TWEAKS).food(ModFoods.SALAD)));
